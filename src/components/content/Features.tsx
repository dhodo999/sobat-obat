        ...
        >
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Sobat Obat hadir untuk memberikan Anda ketenangan pikiran dengan
              menyediakan data medis yang valid dan mudah dicerna oleh siapa
              saja.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-slate-600 leading-relaxed">
                Temukan informasi obat secara instan hanya dengan mengetikkan
                nama merek, kandungan aktif, atau gejala penyakit Anda.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
              ...
              <h4 className="text-xl font-bold text-slate-900 mb-3">
                Akurasi Medis Terjamin
              </h4>
              <p className="text-slate-600 leading-relaxed">
                Seluruh data obat kurasi dan diverifikasi berdasarkan standar
                farmasi resmi dan jurnal medis terpercaya.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-slate-600 leading-relaxed">
                Cegah risiko berbahaya dengan sistem pendeteksi otomatis yang
                memberi peringatan jika obat bertabrakan satu sama lain.
              </p>
            </div>
          </div>
        </motion.div>
