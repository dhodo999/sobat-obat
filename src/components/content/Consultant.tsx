  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-12">
          ...
          <div className="flex justify-center mb-6 shrink-0 relative z-10">
            <div className="bg-slate-100 p-1.5 rounded-full inline-flex shadow-inner">
              <button
                ...
                className={`relative px-6 py-2.5 text-sm font-bold rounded-full transition-all duration-300 ${activeTab === "text" ? "text-blue-700 bg-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
              >
              ...
              <button
                ...
                className={`relative px-6 py-2.5 text-sm font-bold rounded-full transition-all duration-300 ${activeTab === "image" ? "text-blue-700 bg-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
              >
                <div className="flex items-center gap-2">
                  <svg
                    className="w-4 h-4"
      ...
      <div className="lg:col-span-5 flex flex-col justify-start w-full">
        <div className="bg-gradient-to-br from-indigo-900 via-blue-900 to-slate-900 rounded-2xl p-4 md:p-8 shadow-xl border border-blue-800 text-white flex flex-col sticky top-24 max-h-[600px]">
